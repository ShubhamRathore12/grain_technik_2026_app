...
export default function FaultScreen() {
    ...
    const currentTags = getTagsForMachine(machineName || device || '', data?.[0]);
                    ...
                    <View style={[styles.header, { paddingTop: insets.top + 16 }]}>  
                        ...
                        {isConnected && (
                            <View style={[styles.statusBadge, { 
                                backgroundColor: currentTags.length > 0 ? tokens.colors.error : tokens.colors.success 
                            }]}>  
                                <AnimatedText style={styles.statusText} type="caption">
                                    {currentTags.length > 0 ? `${currentTags.length} ${t('ACTIVE')}` : t('ALL CLEAR')}
                                </AnimatedText>
                            </View>
                        )}
                    </View>
                ...
                <View style={[styles.header, { paddingTop: insets.top + 16 }]}>  
                    ...
                    <View style={[styles.statusBadge, { 
                        backgroundColor: isConnected ? 
                            (currentTags.length > 0 ? tokens.colors.error : tokens.colors.success) : 
                ...
                <View style={styles.tabContainer}>
                    ...
                    >
                        ...
                        <AnimatedText style={[styles.tabText, 
                            ...
                            {t('Active Alarms')} ({currentTags.length})
                        </AnimatedText>
                    </TouchableOpacity>
                    <TouchableOpacity
                                ...
                                <>
                                    <View style={styles.sectionHeader}>
                                        <AnimatedText style={[styles.sectionTitle, { color: tokens.colors.text }]} type="h3">
                                            {t('Active Tags')} ({currentTags.length})
                                        </AnimatedText>
                                            ...
                                            <AnimatedCard key={index} animated={true} initialScale={0.95} style={{ margin: 0, marginBottom: 12 }}>
                                                <View style={[styles.alarmCard, { 
                                                    ...
                                                    <View style={styles.alarmInfo}>
                                                        ...
                                                        <AnimatedText style={[styles.alarmStatus, { color: tokens.colors.error }]} type="caption">
                                                            {t('Action Required')}
                                                        </AnimatedText>
                                                    </View>
                                                </View>
